...
<!-- 
	import 태그 : 외부의 문서를 현재문서에 포함시킨다. include 지시어 처럼
		...
		따라서 서로다른 페이지이므로 page 영역은 공유되지 않고, request영역만
		공유된다. scope에 page로 하면 X
 ...
 -->
	...
	<!-- 
		improt 태그의 하위태그로 param을 사용할 수 있다. 지정된 페이지로
		파리미터를 전달한다.
	 -->
	 
	<!-- 
	 	아래와같이 이미지를 삽입할때는 주로 상대경로를 사용하는 것이 좋다.
	...
	<!-- 앞에서 선언한 import태그의 var속성의 변수를 통해 변수를 통해 문서의 내용을 출력한다. -->
	<h4>다른 문서 삽입하기</h4>
	${contents }
