...
//Get 방식이나 post방식이나 실행할때 먼저 실행되는 것  myPostConstruct(), init()
//끝낼때는 destroy(), myPostConstruct()나옴
...
public class LifeCycle extends HttpServlet{
	...
	/*
	 	...
	 	먼저 호출된 후 doGet() 이나 doPost()메서드를 호출한다.
	 	(서비스를 호출하기 때문에 같이 호출되는것?)
	 */
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp)
		...
		/* service()메서드에서 요청방식을 분석한 후 각 메서드를 호출할 때
		 	별도의 호출 문장을 기술하지 않는다. 단지 아래문장이면 된다. */
