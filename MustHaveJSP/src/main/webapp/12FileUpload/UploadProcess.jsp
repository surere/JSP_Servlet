...
// request로 절대경로 만들어줘서 이전데이터에도 다운로드가 가능하게 만들어줌(??)
// String saveDirectory = application.getRealPath("/Uploads");
// 업로드할 파일의 최대용량제한(1mb로 지정함)-서버용량때문에
...
try{
	...
	*/
	...
	/*
		...
		윈도우의 경우 \(역슬래쉬), 리눅스의 경우 /(슬러쉬)를 자동으로
		부여해준다. File객체를 각각 생성한 후 renameTo()메서드를 통해서 변경한다.
	*/
	...
	*/
	...
	/*
		파일업로드에 실패한 경우에는 request 영역에 에러메세지를 
		저장한 후 업로드폼으로 포워드한다.
	*/
	e.printStackTrace();
...
//C:\Dev\apache-tomcat-9.0.78\wtpwebapps\MustHaveJSP\Uploads 이미지 저장 경로
%>
<!DOCTYPE html>
<html>
<head>
