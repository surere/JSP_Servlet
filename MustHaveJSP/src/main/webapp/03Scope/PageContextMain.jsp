...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 /*
 	page 영역 : 하나의 페이지에서만 영역이 공유되고 페이지 이동, 포워드 된
 		페이지에서는 영역이 소멸되어 공유되지 않는다. 즉 해당페이지에서만
 		사용할 수 있는 영역이다. JSP에서의 영역은 데이터를 저장하는
 		공간으로 메모리라고 생각하면 된다.
 */
 // 속성 저장
 // 정수형 데이터
 ...
 /*
 	page 영역을 포함한 4가지 영역을 모든 데이터(객체)를 저장할 수 있다.
 	Object를 기반으로 저장되므로 차후 값을 읽을 때는 해당 타입으로 형변환
 	해야한다.
 */
 %>
<!DOCTYPE html>
...
<body>
	...
	<!-- 
		...
		page영역이 그대로 공유된다.
		즉, include(인클루드)된 페이지의 내용은 정상적으로 출력된다
	 -->
	...
	<!-- 
		...
		되지 않는다. 즉, 아래의 링크를 통해 이동한 페이지에서 아무런 
		내용이 출력되지 않는다.
	 -->
