...
public class WriteController extends HttpServlet{
	...
	// 클라이언트가 작성한 내용을 DB에 입력하고 파일업로드를 처리한다. 
	@Override
	...
	{	
		...
		if(fileName != null) {
			...
			// 파일명과 확장자를 연결해서 새로운 파일명은(을) 생성한다.
		...
		// 서블릿에서 특정 요청명으로 이동할때는 sendRedirect()메서드를 사용하면 된다.
		if(result == 1) {
